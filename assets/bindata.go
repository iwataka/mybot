...
func assetsTmplConfigGeneral_confTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config/general_conf.tmpl", size: 1864, mode: os.FileMode(420), modTime: time.Unix(1531010741, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTmplConfigTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config.tmpl", size: 5451, mode: os.FileMode(420), modTime: time.Unix(1531010741, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
