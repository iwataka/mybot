...
func assetsTmplConfigTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config.tmpl", size: 5459, mode: os.FileMode(420), modTime: time.Unix(1530435441, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
