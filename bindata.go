...
func assetsTmplConfigTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config.tmpl", size: 50361, mode: os.FileMode(436), modTime: time.Unix(1485703630, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTmplTwitter_setupTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/twitter_setup.tmpl", size: 1567, mode: os.FileMode(436), modTime: time.Unix(1485703630, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
