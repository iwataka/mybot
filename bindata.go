...
func assetsTmplConfigFilterTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config/filter.tmpl", size: 5107, mode: os.FileMode(436), modTime: time.Unix(1486287416, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTmplTwitter_setupTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/twitter_setup.tmpl", size: 1567, mode: os.FileMode(436), modTime: time.Unix(1485786553, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
