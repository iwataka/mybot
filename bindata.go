...
func assetsTmplConfigActionTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config/action.tmpl", size: 3719, mode: os.FileMode(436), modTime: time.Unix(1487600170, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTmplConfigTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/tmpl/config.tmpl", size: 20817, mode: os.FileMode(436), modTime: time.Unix(1487597762, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
