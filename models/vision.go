...
type VisionCondition struct {
	...
	Logo     []string            `json:"logo,omitempty" toml:"logo,omitempty" bson:"logo,omitempty" yaml:"logo,omitempty"`
}
...
type VisionFaceCondition struct {
	AngerLikelihood    string `json:"anger_likelihood,omitempty" toml:"anger_likelihood,omitempty" bson:"anger_likelihood,omitempty" yaml:"anger_likelihood,omitempty"`
	BlurredLikelihood  string `json:"blurred_likelihood,omitempty" toml:"blurred_likelihood,omitempty" bson:"blurred_likelihood,omitempty" yaml:"blurred_likelihood,omitempty"`
	HeadwearLikelihood string `json:"headwear_likelihood,omitempty" toml:"headwear_likelihood,omitempty" bson:"headwear_likelihood,omitempty" yaml:"headwear_likelihood,omitempty"`
	JoyLikelihood      string `json:"joy_likelihood,omitempty" toml:"joy_likelihood,omitempty" bson:"joy_likelihood,omitempty" yaml:"joy_likelihood,omitempty"`
}
